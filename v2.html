    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body {
            ...
            overflow-x: hidden; /* Mantido para previnir scroll horizontal acidental */
            background-image:
        ...
        /* CORREÇÃO: Título principal (h1) agora é responsivo usando clamp() */
        h1 {
             font-size: clamp(2rem, 5vw, 2.75rem); /* Adapta o tamanho da fonte à largura da tela */
             line-height: 1.3;
             max-width: 850px; 
             margin-left: auto; 
             margin-right: auto;
        ...
        /* CORREÇÃO DE COR: Seletor mais específico para garantir que a cor seja aplicada, especialmente no link do rodapé */
        .logo-header-text, a.logo-header-text {
        ...
        /* CORREÇÃO: Altura do mockup agora é flexível para evitar overflow em telas menores */
        .phone-mockup { 
            width: 100%; 
            max-width: 380px; 
            height: 70vh; /* Usa a altura da viewport para ser flexível */
            max-height: 750px; /* Mantém um limite máximo de altura */
            margin: 0 auto; 
            background: #0c0c0c; 
        ...
        .plan-price { font-size: 2.5rem; font-weight: 800; margin-top: 15px; } /* Adicionado margem para espaçamento */
        .plan-features { list-style: none; margin: 25px 0; flex-grow: 1; } /* Adicionado flex-grow para empurrar o botão para baixo */
        .plan-features li { margin-bottom: 15px; display: flex; align-items: center; }
        .plan-features li i { color: var(--brand-green); margin-right: 12px; width: 20px; text-align: center;}
        .pricing-plan.decolar .plan-features li i { color: var(--decolar-blue); }
        .pricing-plan.empire .plan-features li i { color: var(--gold); }
        .plan-recommendation { font-size: 0.9rem; color: var(--text-secondary); margin-top: 20px; margin-bottom: 25px; }
        ...
        /* CORREÇÃO: Media query para ajustar animações em telas menores */
        @media (max-width: 992px) { 
            .pricing-plan.popular, .pricing-plan.empire { 
                transform: scale(1); 
                animation: none; 
            } 
        }

        /* CORREÇÃO: Media query geral para telas de celular, ajustando espaçamentos e fontes */
    ...
    <main>
        <section id="hero">
             <div class="container" style="text-align: center;">
                ...
                <h1>Você tem o produto que o Brasil deseja. Por que vender apenas para sua vizinhança?</h1>
